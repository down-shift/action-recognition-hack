...
CLASSES = {0: 'cartwheel', 1: 'catch', 2: 'clap', 3: 'climb', 4: 'dive', 5: 'draw_sword', 6: 'dribble',
           7: 'fencing', 8: 'flic_flac', 9: 'golf', 10: 'handstand', 11: 'hit', 12: 'jump', 13: 'pick', 14: 'pour',
           15: 'pullup', 16: 'push', 17: 'pushup', 18: 'shoot_ball', 19: 'sit', 20: 'situp', 21: 'swing_baseball',
           22: 'sword_exercise', 23: 'throw'}
# все наши классы
SEED = 42
...
def get_frames(path):
    ...
    video = read_video(path, frames_num=8)
...
def analyze_video(file_path):
    ...
    return get_top_props(video)


if __name__ == '__main__':
    analyze_video(
        '/Users/solodanil/PycharmProjects/action-recognition-hack/api/data_storage/videos/cd46bd31-62e2-43fb-bd69-43e2ebce8650/Bartender_School_Students_Practice_pour_u_cm_np1_fr_med_1.avi')
